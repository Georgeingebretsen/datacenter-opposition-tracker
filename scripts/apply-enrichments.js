...
const ENRICHMENT_FILES = [
  ...
  'enrichment-hyperscalers6.json',
  'enrichment-water1.json',
  'enrichment-groups-batch15.json',
  'enrichment-social14.json',
  'enrichment-specs13.json',
  'enrichment-idfix-r18.json',
];
